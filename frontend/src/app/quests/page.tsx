...
import { Activity, ExternalLink, Clock, CheckCircle, AlertTriangle, Wallet, Plus } from "lucide-react";
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full relative z-10 flex flex-col items-center justify-center min-h-[60vh]">
        <EmptyState
          ...
          description="Connect your Stacks wallet to view your funded quests, track agent execution, and manage bounty payouts."
